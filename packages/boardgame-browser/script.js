    ...
    return `
        <div class="game-card bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 hover:border-blue-300">
            <div class="relative">
                ...
                <div class="absolute top-3 right-3 bg-black/70 text-white px-3 py-2 rounded-lg text-sm font-medium">
                    ${game.yearPublished || 'N/A'}
                </div>
                ${game.numPlays > 0 ? `
                    <div class="absolute top-3 left-3 bg-blue-600 text-white px-3 py-2 rounded-lg text-sm font-medium">
                        ${game.numPlays} plays
                    </div>
                ` : ''}
            </div>
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 flex-wrap">
                        ${game.owned ? 
                            '<span class="bg-green-100 text-green-800 px-4 py-2 rounded-full text-xs font-medium">Owned</span>' : ''
                        }
                        ${game.wishlist ? 
                            '<span class="bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-xs font-medium">Wishlist</span>' : ''
                        }
                        ${game.wantToPlay ? 
                            '<span class="bg-yellow-100 text-yellow-800 px-4 py-2 rounded-full text-xs font-medium">Want to Play</span>' : ''
                        }
                        ${!game.owned && !game.wishlist && !game.wantToPlay ? 
                            '<span class="bg-gray-100 text-gray-600 px-4 py-2 rounded-full text-xs font-medium">Other</span>' : ''
                        }
                    </div>
